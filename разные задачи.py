...
#Даны два списка: Объедините эти списки в один:
# lst1 = [1, 2, 3]
# lst2 = [4, 5, 6]
# print(lst1+lst2)
...
# 	'd': 4,
# }
# combined={**dct1, **dct2} применяем метод распаковки для объединения словарей, при дублировании элементов ключи будут обновляться из второго словаря
# print(combined)

# Дан текст со словами. Запишите в список все слова, начинающиеся на букву А

# text = "Астрал, амеба, сайт, ментор, арктика."
# text1 = text.split()
# s = []
# for i in text1:
#   if i.startswith('а') or i.startswith('А'):
#     s.append(i)
# print(" ".join(s), end=' ') # в данном случае пишем ""join для вывода элементов в виде текста, а не списка (без скобок).
# В остальных случаях можно собирать строки в список, в одну строку командой присоединения списков join и удалять переходы на новую строку добавив end, заменяя их на пробелы
...
# Задание 7.2.12 Напишите числа в порядке возрастания через пробел, которые выведет программа из предыдущего задания, если на вход подаются две последовательности чисел:
# a = '1 2 3 5 6'
# b = '4 5 6 7 8'
# a_s , b_s = set(a), set(b)
# a_and_b = a_s.union(b_s)
...
# Задание 7.3.16 (ОТВЕТ НЕ СООТВЕТСТВУЕТ)
# Необходимо сжать последовательности одинаковых цифр, заменив их на формат (количество, цифра)

# Способ 1. Запись результата в словарь. При помощи встроенной функции.
...
# Способ 2. Вывод результата в виде строки.

# s = input()
# item=s[0]                                                                                                                    сохраняем первый символ
# count = 0                                                                                                                    заводим счётчик
# res=''                                                                                                                       и результирующую строку
# for i in s:
#     if i == item:                                                                                                            если символ совпадает с сохранённым,
#         count+=1                                                                                                             то увеличиваем счётчик
#     else:
#         res +=item + str(count)                                                                                              иначе записываем в результат
#         item = i                                                                                                             и обновляем сохранённый символ с его счётчиком
#         count=1
# res+=item + str(count)                                                                                                       и добавляем в результат последний символ
# print(res)


#Уровень 3.7 задачника Python №1 Дана строка. Сделайте заглавной последнюю букву каждого слова в этой строке.
...
# Даны две строки: Получите символы, которые есть и в одной, и в другой строке:

# txt1 = '12345'
# txt2 = '45678'
# t3, t4=set(txt1), set(txt2)
# t5=list(t3.intersection(t4))
# print("".join(t5))
